              ...
              return (
                ...
                >
                  <div className="relative">
                    ...
                    />
                    {/* Availability Badge */}
                    <div className={`absolute top-3 right-3 px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1 ${isAvailableToday
                  ...
                  <div className="pt-14 pb-6 px-6 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-1 mb-4">
                      {doc.doctorDetails?.availability.map(day => (
                        <span
                          key={day}
                          className={`text-xs px-2 py-1 rounded ${day === todayDay
        ...
        {!role ? (
          ...
          <div className="p-8 pt-0 animate-fadeIn">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <Button
                type="submit"
                className={`w-full py-4 text-lg rounded-xl ${role === Role.PATIENT ? 'bg-secondary-500 hover:bg-secondary-600 shadow-secondary-500/30' :
